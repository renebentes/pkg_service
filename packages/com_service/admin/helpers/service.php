...
class ServiceHelper
{
	public static $extension = 'com_service';
	...
	public static function addSubmenu($vName)
	{
		JSubMenuHelper::addEntry(
			JText::_('COM_SERVICE_SUBMENU_CPANEL'),
			'index.php?option=com_service&view=cpanel',
			$vName == 'cpanel'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_SERVICE_SUBMENU_SERVICES'),
			'index.php?option=com_service&view=services',
			$vName == 'services'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_SERVICE_SUBMENU_CATEGORIES'),
			'index.php?option=com_categories&extension=com_service',
			$vName == 'categories'
		);
	}
